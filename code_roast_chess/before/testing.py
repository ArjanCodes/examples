...
class TestingPieces(unittest.TestCase):
    ...
    def testQueenMoves(self):
        self.game.populateWithFen("rnb1kbnr/pppppppp/8/4P1q1/8/8/PPPPPPPP/RNBQKBNR")
        correctMoves = set([(5,4), (4,5), (3,6), (7,4), (7,2), (5,2), (7,3), (5,3), (4,3), (6,4), (6,5), (6,6), (6,2)])
    ...
    def testBishopMoves(self):
        self.game.populateWithFen("rn1qkbnr/pppppppp/8/4b3/8/8/PPPPPPPP/RNBQKBNR")
        correctMoves = set([(3,2), (5,2), (3,4), (2,5), (1,6), (5,4), (6,5), (7,6)])
    ...
    def testKnightMoves(self):
        self.game.populateWithFen("r1bqkbnr/pppppppp/8/8/4n3/8/PPPPPPPP/RNBQKBNR")
        correctMoves = set([(2, 5), (2, 3), (3, 6), (3, 2), (5, 6), (5, 2), (6, 5), (6, 3)])
...
class TestingChecks(unittest.TestCase):
    ...
    def testCheck(self):
        self.game.populateWithFen("rnbqkbnr/ppppp1pp/5p2/6pQ/8/4P3/PPPP1PPP/RNB1KBNR")
    ...
    def testCheckMate(self):
        self.game.populateWithFen("rnb1kbnr/pppp1ppp/8/8/6Pq/5P2/PPPPP11P/RNBQKBNR")
        self.assertTrue(self.game.check_for_check())
