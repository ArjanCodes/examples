...
from tkinter import BOTH, END, Button, Frame, Menu, Text, Tk, filedialog, messagebox
    ...
    def create_ui(self) -> None:
        ...
        if self.show_save_button:
            self.save_button = Button(
                self, text="Save", command=self.on_save_button_clicked
            )
