...
if __name__ == '__main__':
    from plot import plot_sample_image

    idx = 10
    _ = plot_sample_image(load_train_data()[idx], load_train_labels()[idx])
    _ = plot_sample_image(load_test_data()[idx], load_test_labels()[idx])
