from src.commands.validations import (
    value_exists_in_dataframes,
    cols_exists_in_dataframe,
)
...
class MergeCommand(Command):
    def execute(self, args: MergeCommandArgs):  # type: ignore
        file1, file2, left_on, right_on, alias, cols = (
            args.file1,
            args.file2,
            args.left_on,
            args.right_on,
        ...
        file = pd.merge(
            args.model.read(file1),
            args.model.read(file2)[cols],
            how="left",
            left_on=left_on,
            right_on=right_on,
            suffixes=suffixes,
